...
<div id="wrap">
    ...
    <div id="reserved-days" data-bind="foreach: reservedDays">
      <span class='reserved-date' data-bind='click: $root.removeDate'>
    ...
    <div id="total" data-bind='visible: reservedDays().length > 0'>
     ...
     $<span class='sum-amount' data-bind='text: total'></span>
      ...
      <form name="reservationForm" acton="" method="post" />
         ...
         <div id="add-guest">
            <span class='add-guest' data-bind='click: addGuest'><i class="fa fa-plus-circle fa-lg green"></i> Add a guest</span>
         </div>

         <table class='guests-list' data-bind="visible: guests().length > 0">
            <tr>
               <th>First Name</th>
               <th>Last Name</th>
            </tr>
